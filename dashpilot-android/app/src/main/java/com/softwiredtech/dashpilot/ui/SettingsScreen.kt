        ...
        Column(
            ...
            if (selectedTab.intValue == 1) {
                if (bleManager != null && dashkitUpdateManager != null) {
                    DashKitSettingsContent(bleManager, dashkitUpdateManager, teslaStatus, onEnrollTesla)
                } else {
                    Text(
...
private fun DashKitSettingsContent(
    ...
    TeslaKeySection(bleManager, teslaStatus, onEnrollTesla)
    Spacer(modifier = Modifier.height(24.dp))
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    val ok = TeslaClient.sendReset(bleManager)
                    val msg = if (ok) {
