...
@group(2) @binding(1) var<uniform> params: vec4<f32>;  // x = emissive_strength, y = animation_speed
...
fn fragment(
    ...
    let d = sin(mesh.world_position.z * PULSE_FREQUENCY - globals.time * animation_speed);
